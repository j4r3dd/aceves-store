      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
        ...
        <div className="flex flex-col gap-6">
          ...
          <div className="mt-4 flex items-center gap-3">
            ...
            <a 
              href={`https://www.facebook.com/sharer/sharer.php?u=${encodeURIComponent(`https://aceves-store.com/producto/${product.id}`)}`}
              target="_blank" 
            ...
            <a 
              href={`https://twitter.com/intent/tweet?text=${encodeURIComponent(`Mira este hermoso ${product.name} de @acevesjoyeria`)}&url=${encodeURIComponent(`https://aceves-store.com/producto/${product.id}`)}`}
              target="_blank" 
              rel="noopener noreferrer"
            ...
            <a 
              href={`https://api.whatsapp.com/send?text=${encodeURIComponent(`¡Mira lo que encontré en Aceves Joyería! ${product.name}: https://aceves-store.com/producto/${product.id}`)}`}
              target="_blank" 
              rel="noopener noreferrer"
